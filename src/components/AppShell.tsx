...
const NAV: NavItem[] = [
  ...
  { label: 'Settings', soon: true, icon: I(<><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9c.14.31.4.55.72.66" /></>) },
  { label: 'Billing', soon: true, icon: I(<><rect x="2" y="5" width="20" height="14" rx="2" /><path d="M2 10h20" /></>) },
];
...
export function AppShell({
  ...
  const canSee = (perm?: Permission) => !perm || (me != null && roleHasPermission(me.role, perm));
    ...
    <div className="flex min-h-screen">
      <aside className="flex w-64 shrink-0 flex-col bg-brand text-white">
        ...
        <div className="border-b border-white/10 px-4 py-4">
          ...
          {/* Static company card. No switcher: a user belongs to one company.
              A dropdown returns only if we add multi-company membership. */}
